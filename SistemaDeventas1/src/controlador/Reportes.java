...
public class Reportes {
    ...
    public void ReportesClientes() {
        ...
        try {
           ...
           PdfWriter.getInstance(documento, new FileOutputStream("C:/Users/USUARIO/OneDrive/Desktop/Reporte_Clientes.pdf"));
    ...
    public void ReportesProductos() {
        ...
        try {
            String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento, new FileOutputStream("C:/Users/USUARIO/OneDrive/Desktop/Reporte_Productos.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    public void ReportesCategorias() {
        ...
        try {
            String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento, new FileOutputStream("C:/Users/USUARIO/OneDrive/Desktop/Reporte_Categorias.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    public void ReportesVentas() {
        ...
        try {
            String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento, new FileOutputStream("C:/Users/USUARIO/OneDrive/Desktop/Reporte_Ventas.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
